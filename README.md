...
**LeyoAI Cyber Security Assistant (Medium)** — Part of the [LeyoAI](https://leyoai.vercel.app) platform by 杭州市上城区乐友信息服务工作室.
...
model = PeftModel.from_pretrained(base, "richard3153/leyoai-cyber-medium")
model.eval()
...
Also available: [FFZwai/leyoai-cyber-medium](https://huggingface.co/FFZwai/leyoai-cyber-medium)
...
**LeyoAI 网络安全助手（中型版）** — [杭州市上城区乐友信息服务工作室](https://leyoai.vercel.app)旗下 [LeyoAI](https://leyoai.vercel.app) 平台。
...
也可在 HuggingFace 获取：[FFZwai/leyoai-cyber-medium](https://huggingface.co/FFZwai/leyoai-cyber-medium)
